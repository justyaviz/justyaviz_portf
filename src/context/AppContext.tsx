...
const translations = {
  uz: {
    ...
    'hero.role.1': 'Digital Creator',
    'hero.role.2': 'SMM Strategist',
    'hero.role.3': 'Product Builder',
    'hero.role.4': 'Marketing Specialist',
    
    // Hero
    'hero.badge': 'JUST YAVIZ — I build marketing systems, not just content.',
    ...
    'ai.initial_msg': "Salom! Men Yaviz agentligining AI yordamchisiman 🤖. Bugun biznesingizni kuchaytirish bo'yicha qanday maslahat yoki xizmat so'raysiz?",
    
    // Calculator
    'calc.badge': 'Kalkulyator',
    'calc.title': 'Loyihangiz <span class="text-accent italic">narxini</span> hisoblang.',
    'calc.desc': 'Kerakli xizmatlarni tanlang va byudjetingizni taxminiy aniqlab oling.',
    'calc.s1': '1. Qaysi xizmatlar kerak?',
    'calc.s2': '2. Loyiha muddatini tanlang:',
    'calc.speed.normal': 'Standart Muddat',
    'calc.speed.fast': 'Tezroq',
    'calc.speed.asap': 'Juda shoshilinch',
    'calc.speed.normal.desc': 'Shoshilinch emas',
    'calc.speed.fast.desc': '+25% ustama',
    'calc.speed.asap.desc': '+50% ustama',
    'calc.total': 'Umumiy hisob:',
    'calc.disclaimer': 'Eslatma: Bu taxminiy narx. Aniq narx texnik topshiriqdan so\'ng belgilanadi.',
    'calc.cta': 'Loyihani muhokama qilish',
    'calc.report': 'Hisobot',
    'calc.no_select': 'Hali xizmat tanlanmadi.',
    'calc.speed_bonus': 'Tezlik ustamasi',
    'calc.estimated': 'Taxminiy Narx:',
    'calc.submit': 'Loyihani yuborish',

    // Booking
    'book.hero.title': 'Konsultatsiya band qilish',
    'book.hero.desc': 'Loyiha bo\'yicha bepul 30 daqiqalik muloqot.',
    'book.step1': '1. Kunni tanlang:',
    'book.step2': '2. Vaqtni tanlang:',
    'book.step3': '3. Ma\'lumotlaringiz:',
    'book.btn.next': 'Keyingi qadam',
    'book.btn.back': 'Ortga qaytish',
    'book.step3.title': '3. Ma\'lumotlaringizni qoldiring:',
    'book.form.name.label': 'Ismingiz *',
    'book.form.name.placeholder': 'Masalan: Sardor',
    'book.form.phone.label': 'Telefon raqamingiz *',
    'book.form.email.label': 'Email manzilingiz (Ixtiyoriy)',
    'book.selected_time': 'Siz tanlagan vaqt:',
    'book.on_day': 'kuni soat',
    'book.at': 'da',
    'book.loading': 'Band qilinmoqda...',
    'book.btn.submit': 'Tasdiqlash va Joy bron qilish',
    'book.success.title': 'Muvaffaqiyatli!',
    'book.success.msg_start': 'sizning',
    'book.success.msg_end': 'uchun uchrashuvingiz band qilindi. Mutaxassislarimiz tez orada siz bilan bog\'lanishadi.',
    ...
    'bio.title': 'Kim u?',
    'bio.hero.title': 'Yahyobek Tohirjonov Rashidjon o‘g‘li',
    'bio.hero.desc': 'Men — Just Yaviz, digital marketing, kontent yaratish va texnologik yechimlar ishlab chiqish yo‘nalishida faoliyat yurituvchi mutaxassisman.',
    'bio.hero.philosophy': '“Kontent — bu oddiy post emas. Bu — e’tibor, ishonch va sotuv yaratadigan vosita.”',
    'bio.details.age': 'Yosh: 18',
    'bio.details.loc': 'Manzil: Toshkent, O‘zbekiston',
    'bio.details.origin': 'Tug‘ilgan joy: Dang‘ara, Farg‘ona',
    'bio.details.lang': 'Tillari: O‘zbek, Rus, Ingliz',
    'bio.details.email': 'Email: justyaviz@gmail.com',
    'bio.edu.title': 'Ta’lim va Rivojlanish',
    'bio.edu.desc': 'Dang‘ara 1-son Politexnikum bitiruvchisi. Men uchun ta’lim — bu nazariya emas, amaliy natija va real skill.',
    ...
    'bio.goals.title': 'Maqsadlar',
    'bio.goals.desc': 'Global darajadagi digital mutaxassis bo‘lish, yirik marketing va media kompaniya qurish.',
    'bio.branding.badge': 'Professional Positioning',
    'bio.branding.title': '“I build marketing systems, not just content.”',
    'bio.branding.desc': 'Mening asosiy ustunligim — men faqat kontent yaratmayman, balki foydalanuvchini jalb qiladigan, ushlab turadigan va sotuvga olib keladigan to‘liq tizimlar yarataman.',
  ...
  ru: {
    ...
    // Hero
    'hero.badge': 'JUST YAVIZ — Я строю маркетинговые системы, а не просто контент.',
    ...
    'ai.initial_msg': "Привет! Я ИИ-помощник агентства Yaviz 🤖. Какой совет или услугу вы ищете сегодня, чтобы усилить свой бизнес?",

    // Calculator
    'calc.badge': 'Калькулятор',
    'calc.title': 'Рассчитайте <span class="text-accent italic">стоимость</span> вашего проекта.',
    'calc.desc': 'Выберите необходимые услуги и определите примерный бюджет.',
    'calc.s1': '1. Какие услуги нужны?',
    'calc.s2': '2. Выберите срок проекта:',
    'calc.speed.normal': 'Стандартный срок',
    'calc.speed.fast': 'Быстрее',
    'calc.speed.asap': 'Очень срочно',
    'calc.speed.normal.desc': 'Не спеша',
    'calc.speed.fast.desc': '+25% наценка',
    'calc.speed.asap.desc': '+50% наценка',
    'calc.total': 'Общий счет:',
    'calc.disclaimer': 'Примечание: Это ориентировочная цена. Точная цена будет установлена после ТЗ.',
    'calc.cta': 'Обсудить проект',
    'calc.report': 'Отчет',
    'calc.no_select': 'Услуги пока не выбраны.',
    'calc.speed_bonus': 'Наценка за скорость',
    'calc.estimated': 'Примерная цена:',
    'calc.submit': 'Отправить проект',

    // Booking
    'book.hero.title': 'Забронировать консультацию',
    'book.hero.desc': 'Бесплатное 30-минутное общение по проекту.',
    'book.step1': '1. Выберите дату:',
    'book.step2': '2. Выберите время:',
    'book.step3': '3. Ваши данные:',
    'book.btn.next': 'Следующий шаг',
    'book.btn.back': 'Вернуться назад',
    'book.step3.title': '3. Оставьте свои данные:',
    'book.form.name.label': 'Ваше имя *',
    'book.form.name.placeholder': 'Например: Сардор',
    'book.form.phone.label': 'Ваш номер телефона *',
    'book.form.email.label': 'Ваш email (необязательно)',
    'book.selected_time': 'Выбранное время:',
    'book.on_day': 'в день',
    'book.at': 'в',
    'book.loading': 'Бронирование...',
    'book.btn.submit': 'Подтвердить и забронировать',
    'book.success.title': 'Успешно!',
    'book.success.msg_start': '',
    'book.success.msg_end': 'ваша встреча забронирована. Наши специалисты скоро свяжутся с вами.',
    ...
    'bio.sidebar.who': 'Обо мне',
    'bio.title': 'Кто он?',
    'bio.hero.title': 'Яхёбек Тохиржонов Рашиджонович',
    'bio.hero.desc': 'Я — Just Yaviz, специалист в области цифрового маркетинга, создания контента и разработки технологических решений.',
    'bio.hero.philosophy': '«Контент — это не просто пост. Это инструмент, создающий внимание, доверие и продажи».',
    'bio.details.age': 'Возраст: 18',
    'bio.details.loc': 'Ташкент, Узбекистан',
    'bio.details.origin': 'Дангара, Фергана',
    'bio.details.lang': 'Узбекский, Русский, Английский',
    'bio.details.email': 'Email: justyaviz@gmail.com',
    'bio.edu.title': 'Образование и Развитие',
    'bio.edu.desc': 'Выпускник политехникума Дангара. Для меня образование — это не теория, а практические результаты и реальные навыки.',
    'bio.cert.title': 'Сертификаты',
    'bio.cert.desc': 'Международные достижения, полученные в процессе обучения.',
    'bio.exp.title': 'Опыт работы',
    'bio.goals.title': 'Цели',
    'bio.goals.desc': 'Стать цифровым специалистом мирового уровня и построить крупную маркетинговую и медиакомпанию.',
    'bio.branding.badge': 'Профессиональное Позиционирование',
    'bio.branding.title': '«Я строю маркетинговые системы, а не просто контент».',
    'bio.branding.desc': 'Мое главное преимущество — я создаю системы привлечения клиентов, а не просто картинки.',
  ...
  en: {
    ...
    'ai.initial_msg': "Hello! I'm the Yaviz AI assistant 🤖. What advice or service are you looking for today to grow your business?",

    // Calculator
    'calc.badge': 'Calculator',
    'calc.title': 'Calculate the <span class="text-accent italic">cost</span> of your project.',
    'calc.desc': 'Select required services and determine an approximate budget.',
    'calc.s1': '1. Which services do you need?',
    'calc.s2': '2. Select project timeline:',
    'calc.speed.normal': 'Standard Timeline',
    'calc.speed.fast': 'Faster',
    'calc.speed.asap': 'Very urgent',
    'calc.speed.normal.desc': 'No rush',
    'calc.speed.fast.desc': '+25% surcharge',
    'calc.speed.asap.desc': '+50% surcharge',
    'calc.total': 'Total Cost:',
    'calc.disclaimer': 'Note: This is an approximate price. Exact price is determined after TOR.',
    'calc.cta': 'Discuss Project',
    'calc.report': 'Report',
    'calc.no_select': 'No services selected yet.',
    'calc.speed_bonus': 'Speed Surcharge',
    'calc.estimated': 'Estimated Price:',
    'calc.submit': 'Send Project',

    // Booking
    'book.hero.title': 'Book a consultation',
    'book.hero.desc': 'Free 30-minute project discussion.',
    'book.step1': '1. Choose a date:',
    'book.step2': '2. Choose a time:',
    'book.step3': '3. Your data:',
    'book.btn.next': 'Next step',
    'book.btn.back': 'Go back',
    'book.step3.title': '3. Leave your details:',
    'book.form.name.label': 'Your name *',
    'book.form.name.placeholder': 'Example: Sardor',
    'book.form.phone.label': 'Your phone number *',
    'book.form.email.label': 'Your email (Optional)',
    'book.selected_time': 'Selected time:',
    'book.on_day': 'on',
    'book.at': 'at',
    'book.loading': 'Booking...',
    'book.btn.submit': 'Confirm and Book Now',
    'book.success.title': 'Success!',
    'book.success.msg_start': 'your meeting for',
    'book.success.msg_end': 'has been booked. Our specialists will contact you soon.',
    ...
    'bio.sidebar.who': 'About me',
    'bio.sidebar.branding': 'men',
    'bio.title': 'Who is he?',
    'bio.hero.title': 'Yahyobek Rashidjon o‘g‘li',
    'bio.hero.desc': 'I am Just Yaviz, a specialist in digital marketing, content creation, and technical solutions development.',
    'bio.hero.philosophy': '“Content is not just a post. It is a tool that creates attention, trust, and sales.”',
    'bio.details.age': 'Age: 18',
    'bio.details.loc': 'Tashkent, Uzbekistan',
    'bio.details.origin': 'Dangara, Fergana',
    'bio.details.lang': 'Uzbek, Russian, English',
    'bio.details.email': 'Email: justyaviz@gmail.com',
    'bio.edu.title': 'Education & Development',
    'bio.edu.desc': 'Graduate of Dangara Poly-technicum. For me, education is not theory, but practical results and real skills.',
    'bio.cert.title': 'Certificates',
    'bio.cert.desc': 'International achievements gained during study and growth.',
    'bio.exp.title': 'Work Experience',
    'bio.goals.title': 'Goals',
    'bio.goals.desc': 'Becoming a global digital specialist and building a large-scale marketing and media company.',
    'bio.branding.badge': 'Professional Positioning',
    'bio.branding.title': '“I build marketing systems, not just content.”',
    'bio.branding.desc': 'My primary advantage is that I build systems that bring customers, not just simple visuals.',
    'bio.branding.f1': 'Storytelling',
