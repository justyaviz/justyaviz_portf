  ...
  return (
    <div className="pt-32 pb-20 px-6 min-h-screen">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        {loading ? (
           <div className="flex justify-center py-20"><div className="w-10 h-10 border-4 border-accent border-t-transparent rounded-full animate-spin"></div></div>
        ) : blogs.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogs.map((post, i) => (
              <motion.div 
                ...
                className="group cursor-pointer rounded-3xl border border-[var(--border-primary)] overflow-hidden hover:border-accent transition-colors bg-[var(--bg-secondary)]"
              >
                 ...
                 <div className="p-8 space-y-4">
                    ...
                    <div className="pt-4 flex items-center gap-2 text-accent font-bold text-sm uppercase tracking-widest group-hover:gap-4 transition-all">
